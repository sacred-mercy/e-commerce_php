...
<div class="text-2xl mx-4 mt-2 rounded px-2 bg-gray-200 font-semibold flex justify-between items-center">
    ...
    <a id="checkoutBtn" href="orderCheckout.php"
        class="hidden text-white p-2 m-1 btn-sm bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none
        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="mx-auto flex">
                <img id="productImageDialog" alt="E-commerce"
                    class="lg:w-1/3 w-full object-cover object-center rounded border border-gray-200" src="<?php echo IMAGE_PATH ?>" />
